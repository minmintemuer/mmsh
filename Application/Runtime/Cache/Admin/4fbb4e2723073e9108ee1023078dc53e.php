...
<body>
  ...
  <input type = "hidden" name="type" id="type" value="3" style="display: none">
  <input type = "hidden" name="tab" value="<?php echo ($tab); ?>" style="display: none">
</form>
<div class = "row">
  <div class = "col-lg-12 col-md-12 col-xs-12">
    <h1>会员信息</h1><button class="btn btn-primary" onclick="$('#contype').attr('action','<?php echo ($U["content"]); ?>').submit();">+添加会员</button>
  </div>
</div>
