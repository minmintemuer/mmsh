...
<script src="/mmsh/Public/admin/js/respond.min.js"></script>
  <![endif]-->
	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">重庆茂名商会-----登录</div>
				<div class="panel-body">
					<form action="<?php echo ($U['login']); ?>" method="post">
						<fieldset>
							<div class="form-group">
								<input class="form-control" placeholder="请输入用户名" name="user" type="text" autofocus="">
							</div>
							<div class="form-group">
							...
							<div class="checkbox">
								<label>
									<input name="remember" type="checkbox" value="Remember">3天免登录
								</label>
							</div>
