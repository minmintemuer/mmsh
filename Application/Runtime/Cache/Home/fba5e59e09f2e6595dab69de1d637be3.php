                ...
                <div class="sideMenu">
                    ...
                    <div class = "sideTit" style="background-color:#d60011;">
                        <a href = "<?php echo ($U['Index_info']); ?>" style="display:inline-block;text-decoration:none;">
                            <h3><i class="fa fa-user-circle" aria-hidden="true" style="color:#930000;"></i>&nbsp;商会会员</h3>
                            <p style="margin-left:20px;">member</p>
                        </a>
                        <style>
               ...
               background-repeat:no-repeat !important;background-size:100% 100% !important;" >
                        ...
                        <div class="collapse navbar-collapse" id="navbar-ex-collapse2" >
                            <ul class="nav navbar-nav navbar-right text-center">
                                <?php if(is_array($leibie)): $i = 0; $__LIST__ = $leibie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i; if($data["id"] == $leiming['id']): ?><li class="21 on">
                                    ...
                                    <i class="ibg">&nbsp;</i>
                                    <a  href="<?php echo ($U['Index_insider']); ?>/id/<?php echo ($data["id"]); ?>"><?php echo ($data["name"]); ?></a>
                ...
                <div class="sideContact hidden-xs" style="background-image:url(/mmsh/Public/images/contactBg.jpg);">
                     <div class="sideContactTit">
                         <a style="text-decoration:none;"><i style="color:#930000;" class="fa fa-comment" aria-hidden="true"></i>
                             联系我们
                         </a></div>
                ...
                <div class="Ml">
                    <div class="path">
                        ...
                        <div class="pathdiv" style="margin-top:20px;">
                            ...
                            <span>&gt;</span>
                            <a href="<?php echo ($U['Index_insider']); ?>.html">商户会员</a>
                            <span>&gt;</span>
                            <span class="on"><?php echo ($leiming["name"]); ?></span>
                        </div>
                    </div>
                    <ul class="downLoad newsList">
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$centent): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($U['Index_insider_cont']); ?>/id/<?php echo ($centent["id"]); ?>.html"><span><?php echo (substr($centent["date"],0,10)); ?></span><div><?php echo ($centent["name"]); ?></div></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                    <div class="pageds">
                        <?php echo ($page); ?>
                    </div>
