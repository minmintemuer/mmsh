   ...
   <div class="container">
       <div class="row Mp">
           <div class="col-md-3 padding-none" >
               <div class="sideMenu" style="background-color:#fff;" >
                   <!--带箭头的栏目块，开始-->
                   <div class = "sideTit" style="background-color:#d60011;">
                       <a href = "<?php echo ($U['Index_info']); ?>" style="display:inline-block;text-decoration:none; ">
                           ...
                           <p style="margin-left:20px;">active</p>
                       </a>
                       <style>
                       ...
                       <div class="collapse navbar-collapse" id="navbar-ex-collapse2" >
                           <ul class="nav navbar-nav navbar-right text-center">
                               <?php if(is_array($leibie)): $i = 0; $__LIST__ = $leibie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i; if($data["id"] == $leiming['id']): ?><li class="21 on">
                                   ...
                                   <i class="ibg">&nbsp;</i>
                                   <a  href="<?php echo ($U['Index_dongtai']); ?>/id/<?php echo ($data["id"]); ?>"><?php echo ($data["name"]); ?></a>
           ...
           <div class="col-md-9" style="background-color:#e6e6fa;height:auto;">
               <div  class="Ml">
                   <div class="path">
                       ...
                       <div class="pathdiv">
                           <a href="#">首页</a>
                           <span>&gt;</span><a href="<?php echo ($U['Index_dongtai']); ?>.html">商户动态</a>
                           <span>&gt;</span><span class="on"><?php echo ($leiming["name"]); ?></span>
                       </div>
                   </div>
                   <ul class="downLoad newsList">
                       <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$centent): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($U['Index_dongtaiX']); ?>/id/<?php echo ($centent["id"]); ?>.html"><span><?php echo (substr($centent["date"],0,10)); ?></span><div><?php echo ($centent["name"]); ?></div></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                   </ul>
                   <div class="pageds">
                       <?php echo ($page); ?>
                   </div>
