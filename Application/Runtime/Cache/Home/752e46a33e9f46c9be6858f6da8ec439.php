...
<div class="section"  style="background-color:#e6e6fa;">
    <div class="container">
        <div class="col-md-3 padding-none Mp">
            <div class="sideMenu">
                <div class="sideTit">
                    <a style="text-decoration:none;"href="<?php echo ($U['Index_dongtai']); ?>">
                        <h3>商会公告分类</h3>
                        <p>introduces</p>
                    </a>
                </div>
            ...
            <div class="sideContact hidden-xs" style="background-image:url(/mmsh/Public/images/contactBg.jpg);">
                <div class="sideContactTit">
                    <a href="<?php echo ($U['Index_contact']); ?>">联系我们</a>
                </div>
                <div class="sideContactBox">
                    <div><?php echo ($info->address); ?></div>
                    <div><?php echo ($info->tel); ?></div>
                    <div><?php echo ($info->email); ?></div>
                    <div><?php echo ($info->fax); ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-9 Mp" style="background-color:#e6e6fa;;height:auto;">
             <div class="Ml">
            <div class="path">
                <div class="insider">
                ...
                <div class="pathdiv" style="margin-top:20px;">
                    <a href="<?php echo ($U['Index_index']); ?>" style="text-decoration: none;">
                        首页
                    </a>
                    <span>&gt;</span>
                    <a href="<?php echo ($U['Index_gonggao']); ?>">商户动态</a>
                    <span>&gt;</span>
                    <span href="" class="on"><?php echo ($leiming["name"]); ?></span>
                </div>
            </div>
